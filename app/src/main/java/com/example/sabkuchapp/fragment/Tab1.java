package com.example.sabkuchapp.fragment;
...
public class Tab1 extends Fragment {
    ...
    private Retrofit retrofit=AppController.retrofitProduct;
    private IApiClass api=retrofit.create(IApiClass.class);
    ...
    public void addData(String productId){

        Call<ProductResponse> call=api.getProduct(productId);
